...
The R scripts needed to extract data from the summary statistics, process and run CoPheScan is available in this repository:
 ...
 - sim02_collate_prepare_data_mcmc.R
    ...
    Collate the data from all files generated using sim01_cophe_extract_lbf.R for  input to the hierarchical model. [he files sim_data.RData and sim_effect.RData (in sim_processed.tar.gz) are available in figshare]

 - sim03_run_cophe_mcmc_full.R
        
        Run MCMC hierarchical model
